...
export default {
  ...
  translation: {
    common: {
      ...
      shareBoard_title: 'Share Board',
      shareBoardDescription: 'Anyone with this link can view this board (read-only access).',
      shareBoardDisabledDescription:
        'Public sharing is currently disabled for this board. Enable it to generate a shareable link.',
